...
4.  **T-test**
    ...
    t_test
    ```
We here have a p-value of 0.02, which cannot reject the null hypothesis. 
During the writing of this report another result was recorded but was not counted in the above coding. If we count the last result, p-value would be approximately 0.0005357, since the last participant hit the full score. 
In the meantime, it shows that a much smaller sample than planned would largely affect the result. 
